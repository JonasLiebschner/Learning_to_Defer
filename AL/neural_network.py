...
class NetSimple(nn.Module):
    ...
    '''
    def __init__(self, num_classes, channels = 1, width1 = 6, width2 = 16,ff_units1 = 120, ff_units2 = 84):
        super().__init__()
        self.conv1 = nn.Conv2d(channels, width1, 5)
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(width1, width2, 5)
        self.fc1 = nn.Linear(width2 * 841, ff_units1)
...
class NetSimpleRaw(nn.Module):
    ...
    def __init__(self, num_classes, width1 = 6, width2 = 16,ff_units1 = 120, ff_units2 = 84):
        ...
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(width1, width2, 5)
        self.fc1 = nn.Linear(width2 * 580 * 580, ff_units1)
        self.fc2 = nn.Linear(ff_units1, ff_units2)
        self.fc3 = nn.Linear(ff_units2, num_classes)
